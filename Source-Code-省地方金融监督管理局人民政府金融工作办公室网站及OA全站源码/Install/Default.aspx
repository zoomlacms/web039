<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_mgozf1yl" responseencoding="utf-8" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
...
<div class="container-fulid instcon">
    ...
    <div class="container content_body">
        <div class="control-label insok">
              <h2><a class="btn btn-primary btn-lg" href="/Default.aspx"><i class="fa fa-check"></i><%=Resources.L.已经成功安装点此进入首页 %></a><br/><span>重装请定义Config/AppSettings文件Installed值为false</span>
			  </h2>
 </div>
        </div>
    </div>
