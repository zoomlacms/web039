<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.Group, App_Web_154lhpuu" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      ...
      <td><asp:TextBox class="form-control" style="max-width:150px;float:left;" ID="txtRebateRate" runat="server">0</asp:TextBox><span>值范围:0-100,0为不启用</span>
