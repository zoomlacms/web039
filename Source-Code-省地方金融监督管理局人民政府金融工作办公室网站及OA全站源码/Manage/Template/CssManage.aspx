<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_CssManage, App_Web_qqejcv3h" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table width="100%" class="table table-bordered">
        <tr>
            <td align="left"><asp:Label ID="lblDir" runat="server"></asp:Label>
            </td>
            <td align="right">
