define(function (require, exports, module) {
    ...
    _self.prototype.Init = function (model, extend) {
        ...
        ref.timer = null;
        ref.offset = 5000;//间隔
        for (var i = 0; i < model.dataMod.items.length; i++) {
            var item = model.dataMod.items[i];
...
+ "                <div id=\"image_{{item.orderid}}\" ng-repeat=\"item in list.@id.dataMod.items|orderBy:'orderid'\">"
...
+ "                    <li ng-repeat=\"item in list.@id.dataMod.items|orderBy:'orderid'\" style=\"margin: 0px 7px; width: 90px; display: inline; float: left; height: 60px\">"
