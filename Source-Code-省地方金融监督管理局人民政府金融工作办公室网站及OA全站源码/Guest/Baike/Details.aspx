<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Guest/Baike/Baike.master" clientidmode="Static" inherits="Guestbook_BkDetails, App_Web_2iydnt4h" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="tittle_div">
    ...
    <div class="pull-right">
        <span class="bk_top_btn" title="收藏"><i class="fa fa-heart"></i> 收藏</span><span class="margin_l5">|</span>
        <span class="bk_top_btn" title="点赞"><i class="fa fa-thumbs-o-up"></i> 点赞</span>
    </div>
</div>
<div class="brief_div">
