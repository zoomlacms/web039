<%@ page language="C#" autoeventwireup="true" inherits="User_UserFunc_Money_GiveMoney, App_Web_ntzcutml" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered">
        ...
        <tr>
            <td class="td_m text-right">赠送人:</td>
            <td>
