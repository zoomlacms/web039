<%@ page language="C#" autoeventwireup="true" inherits="User_UserFunc_WithDraw, App_Web_ntzcutml" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container">
    <table class="table table-bordered table-hover table-striped">
            <tr><td>现有金额：</td><td><asp:Label runat="server" ID="NowMoney_L" /></td></tr>
            <tr><td>申请日期：</td><td><asp:Label runat="server" ID="CDate_L" /></td></tr>
            <tr><td>提现金额：</td><td>
                <asp:TextBox runat="server" ID="Money_T" CssClass="form-control text_300" />
