...
PageHelper.prototype.Init = function (option) {
    var ref = this;
...
PageHelper.prototype.Render = function () {
    var ref = this;
    $("#" + ref.id).html(ref.GetPageHtml());
    ref.InitPageEvent();
}
PageHelper.prototype.GetCPage = function () {
    var ref = this;
...
PageHelper.prototype.GetPageHtml = function () {
    var ref = this;
...
PageHelper.prototype.GetStartPage = function (cpage) {
    var ref = this;
    return cpage - (cpage % ref.pnum) + 1;
}
PageHelper.prototype.ReplacePageTlp = function (page, pagename, classname) {
    var pagetlp = '<li class="@classname"><a href="javascript:;" class="page_btn" data-page="@pagenum" type="button">@pagename</a></li>';//页数模板
    return pagetlp.replace(/@pagenum/g, page).replace(/@pagename/g, pagename).replace(/@classname/g, classname);
}
PageHelper.prototype.InitPageEvent = function () {
    //在页面html生成后,绑定按钮事件
    var ref = this;
...
PageHelper.prototype.PageClick = function (param) {
    var ref = param.ref;
...
//-----------------辅助方法,Json全加载本地时使用
PageHelper.prototype.GetPageDT = function (data, cpage, psize) {
    var ref = this;
...
PageHelper.prototype.GetPageNum = function (itemCount, psize) {
